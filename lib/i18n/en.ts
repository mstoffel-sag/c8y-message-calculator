...
export const en = {
  ...
  'series.solo.split': '{types} messages per sample — {max} series is the most one measurement should carry',
  ...
  'series.messagesForAll': '{types} messages per sample — {max} series is the most one measurement should carry',
