...
export const de: Record<Key, string> = {
  ...
  'series.col.retention': 'Aufbewahrt',
  'series.retention.title': 'Tage, die die Aufbewahrungsregel des Tenants diesen Messtyp hält. Leer lassen für den Standardwert des Szenarios, der im Schritt Vertrag gesetzt wird. Die Zahl der Nachrichten ändert sich dadurch nicht — nur, wie viel zum Monatsende noch in der Datenbank liegt, und darauf wird der Speicher abgerechnet.',
  'series.retention.inherited': 'Standard des Szenarios',
  'series.retention.shared': 'wie ihr Messtyp',
  ...
  'storage.retentionDecides': '**Die Aufbewahrung entscheidet über die Größe, nicht der Verkehr.** Identischer Verkehr, 90 Tage gehalten, belegt dreimal so viel wie bei 30. Dieser Maschinenpark wird **{kept}** aufbewahrt{note} — eine Regel pro Messtyp im Schritt Messungen, darüber ein Standardwert und die Bytes pro Wert im Schritt Vertrag.',
  'storage.retentionDefault': ' (die Ausgangsannahme)',
  'storage.measurementsOnly': 'Nur Messungen. Ereignisse, Alarme, Inventarschreibvorgänge und Operationen werden auch gespeichert, aber die Quelle hat Datenpunkte gemessen; sie sind **{share}** der Dokumente, die dieser Maschinenpark schreibt.',
