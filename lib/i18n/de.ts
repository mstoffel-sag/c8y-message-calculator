...
export const de: Record<Key, string> = {
  ...
  'storage.sub': 'Was am vollsten Tag auf der Platte liegt — die Zahl, die ODS abrechnet',
  'storage.stat.ods': 'Operational Data Store',
  'storage.stat.ods.sub': 'bei {bytes} B / Wert · {range} über die Spanne',
  'storage.stat.fullest': 'Vollster Monat',
  'storage.stat.fullest.sub': '{days} Tage aufbewahrt',
  ...
  'storage.stat.dataHub': 'DataHub-Extrakt',
  'storage.stat.dataHub.sub': '20–25 % derselben Daten',
  'storage.odsCell': '**{amount} gehen in die ODS-Zelle**, bei {bytes} Bytes pro Wert. Das ist eine Zahl aus einer Spanne, und die Spanne ist der Befund: {note} Überschreiben Sie sie im Deployment-Abschnitt, wenn der Tenant gemessen wurde.',
  ...
  'storage.retentionDecides': '**Die Aufbewahrung entscheidet über die Größe.** Identischer Verkehr, 90 Tage gehalten, belegt dreimal so viel wie bei 30. Hier sind es **{days} Tage**{note} — setzen Sie diese und die Bytes pro Wert auf die eigenen Zahlen des Tenants im Schritt Vertrag.',
