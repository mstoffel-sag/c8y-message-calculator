...
export const de: Record<Key, string> = {
  ...
  'series.teach.body': 'Eine Messung trägt **einen Zeitstempel** und beliebig viele Messreihen darunter. Ein `POST` ist **eine Nachricht**, ob er eine Reihe trägt oder vierzig. Die Frage, die Ihr Volumen entscheidet, ist also nicht, wie viele Daten Sie senden — sondern **auf wie viele Requests Sie sie verteilen**.\n\nDamit ist das Abtastintervall die natürliche Gruppierung: alles, was auf demselben Takt abgetastet wird, teilt einen Zeitstempel und kann eine Messung teilen. Werte auf *verschiedenen* Intervallen können sich niemals eine teilen, so verwandt sie auch sind.\n\n**Ein Schalter oder ein Status ist auch eine Messreihe** — und das Intervall, das Sie ihm geben, ist das Intervall, für das Sie zahlen. Ein Kompressor-Ein/Aus, das auf dem Minutentakt des Maschinenparks bleibt, kostet 44.640 Ablesungen pro Maschine und Monat, um etwas zu erfahren, das sich ein paar Dutzend Mal am Tag bewegt. Fragen Sie, wie oft es sich wirklich ändert, und tasten Sie dort ab: zwanzigmal täglich ist eine Ablesung alle 72 Minuten, und dasselbe Wissen kostet 620.\n\n**Sagen Sie dem Werkzeug also das Intervall, und es entwirft den Messtyp.** Jede Messreihe, die Sie hinzufügen, landet automatisch im Messtyp für ihr Intervall, unter einem vorgeschlagenen Namen. Beide Hälften davon können Sie in der Spalte *Messtyp* ändern: benennen Sie das Fragment um, das Ihre Geräte wirklich senden, oder verschieben Sie eine Reihe in einen eigenen Messtyp.',
